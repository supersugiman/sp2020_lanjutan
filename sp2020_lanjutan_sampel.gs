...
var sheet = ss.getSheetByName("capi"); //name sheet
...
function Tambah(e, sheet){
  ...
  var mati = e.parameter.mati;
  var hamil = e.parameter.hamil;
  var kunjungan = e.parameter.kunjungan;
 ...
 // Logger.log(flag);
  ...
  //if(flag==1)
  {
  var rowData = sheet.appendRow([idnks,idruta,nus,kunjungan,art,mati,catatan,alamat,latilongi,new Date,hamil]);  
